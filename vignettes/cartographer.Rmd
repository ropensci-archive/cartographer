...
vignette: >
  %\VignetteIndexEntry{Cartographer}
...
The [cartographer package](https://github.com/ropensci/cartographer) for R lets you create interactive, exploratory maps inside R. ([Installation instructions](https://github.com/lmullen/cartographer).) These maps are intended for use in data exploration. Cartographer provides the ability to plot points and scale them, to draw GeoJSON or TopoJSON polygons, and to use map tiles from popular providers.
